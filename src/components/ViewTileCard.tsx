...
interface ViewTileCardProps {
  tile: Tile
  index: number
}

export const ViewTileCard = memo(function ViewTileCard({ tile, index }: ViewTileCardProps) {
  const { url } = usePublicThumbnail(tile.thumbFileId)
  ...
  return (
    <div
      className={`
        ...
        transition-all duration-200 animate-tile-in
